...
func NewRestApi(port, certSRT, certKEY string, isTSL bool) {
	...
	r.HandleFunc("/api/user/debit", debits).Methods(http.MethodGet)
	r.HandleFunc("/api/user/debit/categories", debitCategories).Methods(http.MethodGet)
	r.HandleFunc("/api/user/credit", credits).Methods(http.MethodGet)
	r.HandleFunc("/api/user/credit/categories", creditCategories).Methods(http.MethodGet)
